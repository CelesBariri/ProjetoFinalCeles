...
namespace ProjetoFinalCeles.Controllers
{
    public class CidadeController : Controller
    {
        ...
        public async Task<IActionResult> Index( string pesquisa )
        {
            ...
            {
                var contexto = _context.Cidade
                    .Where(x => x.CidadeNome.Contains(pesquisa)).Include(c => c.Estado);
                return View(await contexto.ToListAsync());
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,CidadeNome,EstadoId")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CidadeNome,EstadoId")] Cidade cidade)
        {
            if (id != cidade.Id)
            {
                return NotFound();
